/**
 * Servicios (subItems del menú SKILLS) - solo los hijos, sin el menú padre.
 * Usado en Header (submenu) y Footer (lista de servicios).
 */
export const SERVICES_MENU_ITEMS = [
  ...
  { label: "BOLD BTL", href: "/servicios/btl" },
  { label: "MOTION GRAPHICS & 3D", href: "/servicios/motion-3d" },
]
